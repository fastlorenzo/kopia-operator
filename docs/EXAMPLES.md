...
### Example 2: Repository with Direct Password (Not Recommended)
...
spec:
  ...
  username: admin
  storageType: filesystem
  repositoryPassword: "test-password-123" # Not recommended for production
...
spec:
  ...
  storageType: filesystem
  repositoryPasswordExistingSecret: shared-repo-password
  defaultSchedule: "0 2 * * *"
...
1. **Use Secrets for Passwords**: Always use `repositoryPasswordExistingSecret` instead of `repositoryPassword`
